...
using TripBookingBE.Web.Middleware.Startup;
...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        // builder.Services.AddTransient<IStartupFilter, HelloTalkerFilter>();
        ...
        //db context
        builder.Services.AddDbContext<TripBookingContext>(options => options.UseSqlServer(config.GetConnectionString("TripBookingContext")));
        ...
        if (!app.Environment.IsDevelopment())
        {
            ...
            // The default HSTS value is 30 days. You may want to change this for production scen2arios, see https://aka.ms/aspnetcore-hsts.
            app.UseHsts();
        }
